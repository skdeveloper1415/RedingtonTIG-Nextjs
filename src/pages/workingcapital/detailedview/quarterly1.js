...
const particulars = () => {
    return (
       ...
       <Link href="/workingcapital/detailedview/quarterly" className='font-sm' ><i className='pi pi-arrow-circle-left'></i> Accounts Receivable</Link> 
        </div>
        </>
                ...
                <div className="inner-page-wrap xl:pl-[2.083vw] pl-5 xl:pr-[1.979vw] pr-5">
                    ...
                    <div className='xl:py-[1.250vw] py-5'>
                        ...
                        <div className='flex gap-3 items-center'>
                            ...
                            <div><Link href={''} className='text-[#344054] dark:text-[#CACED1] font-medium text-sm xl:text-[0.729vw] rounded-lg xl:px-4 px-[1.042vw] py-2 xl:py-[0.521vw] bg-white dark:bg-[#272F31] border border-[#C6CBD2] dark:border-[rgba(221,232,237,0.10)] inline-block'>Daily</Link></div>
                                ...
                                <div><Link href={'/workingcapital/detailedview'} className='text-[#344054] dark:text-[#CACED1] font-medium text-sm xl:text-[0.729vw] rounded-lg xl:px-4 px-[1.042vw] py-2 xl:py-[0.521vw] bg-white dark:bg-[#272F31] border border-[#C6CBD2] dark:border-[rgba(221,232,237,0.10)] inline-block'>Monthly</Link></div>
                                <div><Link href={''} className='text-[#344054] dark:text-[#CACED1] font-medium text-sm xl:text-[0.729vw] rounded-lg xl:px-4 px-[1.042vw] py-2 xl:py-[0.521vw] bg-white dark:bg-[#272F31] border border-[#C6CBD2] dark:border-[rgba(221,232,237,0.10)] inline-block active-green'>Quartely</Link></div>
                        ...
                        <div className='border border-[#C6CBD2] dark:border-[#14161A] border-t-0 cust_table_css tableheader workingqutr'>
                            <DataTable value={sales} scrollable footerColumnGroup={footerGroup} paginator rows={4} rowsPerPageOptions={[5, 10, 25, 50]} paginatorTemplate="PrevPageLink PageLinks NextPageLink" className='custpaginator custIcons custmBtnTable custTable custHeader' >
                                <Column field="product" headerClassName='header-filter' header={particulars} body={BuBodyTemplate} style={{ minWidth:'5rem'}}/>
                    ...
                    >
                        ...
                        <div className='xl:p-[1.250vw] p-5'>
                            ...
                            <div className='xl:mt-[1.250vw] mt-5 xl:p-[0.833vw] p-3   dark:bg-[#171618] rounded lg:h-[auto]'>
