...
const particulars = () => {
    return (
       ...
       <Link href="/workingcapital/detailedview"><i className='pi pi-arrow-circle-left'></i> Accounts Receivable</Link> 
        </div>
        </>
...
export default function Index() {
    ...
    const BuBodyTemplate = (rowData) => {
        return (
            <div><Link href={'/workingcapital/detailedview/inventorydetail'} className='flex items-center space-x-2'><i className='red-tsg-plus'></i><span>CAABU</span></Link></div>
        );
    };
          ...
          <div>
            ...
            <div>
              ...
              >
                ...
                <div className="inner-page-wrap xl:pl-[2.083vw] pl-5 xl:pr-[1.979vw] pr-5">
                    ...
                    <div className='xl:py-[1.250vw] py-5'>
                        <div className='bg-white dark:bg-[#14161A] border border-[#C6CBD2] dark:border-[#14161A] rounded-tl-lg rounded-tr-lg px-5 xl:px-[1.250vw] py-2 flex justify-between items-center'>
                            <div className='flex gap-3 items-center'>
                                ...
                                <div className='text-[#888888] text-sm space-x-2 font-normal'>
                                    <Link href={'/workingcapital/detailedview'} className='text-[#0056B8] font-semibold'>Particulars</Link>
                            ...
                            <div><Link href={''} className='text-[#344054] dark:text-[#CACED1] font-medium text-sm xl:text-[0.729vw] rounded-lg xl:px-4 px-[1.042vw] py-2 xl:py-[0.521vw] bg-white dark:bg-[#272F31] border border-[#C6CBD2] dark:border-[rgba(221,232,237,0.10)] inline-block'>Daily</Link></div>
                                ...
                                <div><Link href={'/workingcapital/detailedview/quarterly1'} className='text-[#344054] dark:text-[#CACED1] font-medium text-sm xl:text-[0.729vw] rounded-lg xl:px-4 px-[1.042vw] py-2 xl:py-[0.521vw] bg-white dark:bg-[#272F31] border border-[#C6CBD2] dark:border-[rgba(221,232,237,0.10)] inline-block'>Quarterly</Link></div>
                        ...
                        {/* <div className='border border-[#C6CBD2] dark:border-[#14161A] border-t-0 cust_table_css'> */}
                            <div className='border border-[#C6CBD2] dark:border-[#14161A] border-t-0 cust_table_css tableheader  workingqutr'>
                            <DataTable value={sales} scrollable footerColumnGroup={footerGroup} paginator rows={4} rowsPerPageOptions={[5, 10, 25, 50]} paginatorTemplate="PrevPageLink PageLinks NextPageLink" className='custpaginator custIcons custmBtnTable custTable custHeader' >
                                <Column field="product" headerClassName='header-filter' header={particulars} body={BuBodyTemplate} />
                                <Column field="lastYearSale" sortable header="January" body={lastYearProfitBodyTemplate} />
                                <Column field="thisYearSale" sortable header="February" body={thisYearProfitBodyTemplate} />
