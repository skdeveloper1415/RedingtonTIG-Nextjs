...
export default function Index() {
    ...
    const BuBodyTemplate = (rowData) => {
        return (
            <div><Link href={'/workingcapital/detailedview/quarterly1'} className='flex items-center space-x-2'><i className='red-tsg-plus'></i><span>Inventory</span></Link></div>
        );
    };
              ...
              >
                ...
                <div className="inner-page-wrap xl:pl-[2.083vw] pl-5 xl:pr-[1.979vw] pr-5">
                    ...
                    <div className='xl:py-[1.250vw] py-5'>
                        ...
                        <div className='border border-[#C6CBD2] dark:border-[#14161A] border-t-0 cust_table_css tableheader '>
