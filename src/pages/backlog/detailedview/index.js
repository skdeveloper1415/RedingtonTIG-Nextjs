...
export default function Index() {
    /*--checkbox--*/
      ...
      const Backlog_BU_DetailViewloading = useSelector(state => state.backlog.Backlog_BU_DetailViewloading);
  ...
  const [name, setName] = useState('BU')
  ...
  let Backlog_BU_DetailViewData = customGroupBy(Backlog_BU_DetailView, ['Week_Day', 'BU'], ['Total'])
...
let returnsbuCustomHeaderTotal = [
  ...
  let sbuTableColumns = [];
  Backlog_BU_DetailViewData && Backlog_BU_DetailViewData.forEach((sbu) => {
  ...
  return (
    ...
    <div className='bg-white dark:bg-[#14161A] border border-[#C6CBD2] dark:border-[#14161A] rounded-tl-lg rounded-tr-lg px-5 xl:px-[1.250vw] py-2 flex justify-between items-center'>
        ...
        <div className='flex items-center gap-2'>
            <div className='text-[#029046] dark:text-[#CACED1] font-medium text-sm xl:text-[0.729vw] flex items-center space-x-2 cursor-pointer mr-6 xl:mr-[0.781vw] xl:px-4 px-[1.042vw] py-2 xl:py-[0.521vw]'><ExcelDownloader data={Backlog_BU_DetailView} /></div>
            ...
            <div><Link href={'/backlog/detailedview'} className='text-[#344054] dark:text-[#CACED1] font-medium text-sm xl:text-[0.729vw] rounded-lg xl:px-4 px-[1.042vw] py-2 xl:py-[0.521vw] bg-white dark:bg-[#272F31] border border-[#C6CBD2] dark:border-[rgba(221,232,237,0.10)] inline-block active-green'>BU</Link></div>
    ...
    {/* <DataTable value={sales} footerColumnGroup={footerGroup} scrollable paginator rows={4} rowsPerPageOptions={[5, 10, 25, 50]} paginatorTemplate="PrevPageLink PageLinks NextPageLink" className='custpaginator custIcons custmBtnTable custTable' >
            ...
            <LoaderContainer loading={Backlog_BU_DetailViewloading}>
            <CustomTable
                          pagination={true}
                          // size="small"
                            ...
                            return (
                              <>
                                <Table.Summary.Row className="totalcell  dark:text-[#FFFFFF]">
                                  ...
                                  <Table.Summary.Cell index={0}><b>Over all</b></Table.Summary.Cell>
                                  {
