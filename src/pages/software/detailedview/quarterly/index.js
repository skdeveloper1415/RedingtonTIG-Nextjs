...
export default function Index() {
    ...
    const BuBodyTemplate = (rowData) => {
        return (
            <div><Link href={'/software/detailedview/quarterly/tableu'} className='flex items-center space-x-2'><i className='red-tsg-plus'></i><span>TABLEU</span></Link></div>
        );
    };
  ...
  return (
    ...
    <div className='bg-white dark:bg-[#14161A] border border-[#C6CBD2] dark:border-[#14161A] rounded-tl-lg rounded-tr-lg px-5 xl:px-[1.250vw] py-2 flex justify-between items-center'>
        ...
        <div className='flex items-center gap-2'>
            ...
            <div><Link href={'/software/detailedview'} className='text-[#344054] dark:text-[#CACED1] font-medium text-sm xl:text-[0.729vw] rounded-lg xl:px-4 px-[1.042vw] py-2 xl:py-[0.521vw] bg-white dark:bg-[#272F31] border border-[#C6CBD2] dark:border-[rgba(221,232,237,0.10)] inline-block'>Monthly</Link></div>
