...
export default function Index() {
  ...
  const BuBodyTemplate = (rowData) => {
    return (
      <div><Link href={'/software/detailedview/tableu'} className='flex items-center space-x-2'><i className='red-tsg-plus'></i><span>TABLEU</span></Link></div>
    );
  };
          ...
          <div className=''>
            <div className='bg-white dark:bg-[#14161A] border border-[#C6CBD2] dark:border-[#14161A] rounded-tl-lg rounded-tr-lg px-5 xl:px-[1.250vw] py-2 flex justify-between items-center'>
              <div className='flex gap-3 items-center'>
                <div className='text-[#101828] dark:text-[#CACED1] font-normal text-base xl:text-[0.938vw] flex items-center space-x-3'>
                  {/* <Link href={'/inventory/detailedview'} className='text-sm'><i className='red-tsg-back-rounded'></i></Link> */}
              ...
              <div className='flex items-center gap-2'>
                ...
                <div><Link href={'/software/detailedview/quarterly'} className='text-[#344054] dark:text-[#CACED1] font-medium text-sm xl:text-[0.729vw] rounded-lg xl:px-4 px-[1.042vw] py-2 xl:py-[0.521vw] bg-white dark:bg-[#272F31] border border-[#C6CBD2] dark:border-[rgba(221,232,237,0.10)] inline-block'>Quarterly</Link></div>
            ...
            <div className='border border-[#C6CBD2] dark:border-[#14161A] border-t-0 cust_table_css'>
              <DataTable value={sales} footerColumnGroup={footerGroup} scrollable paginator rows={8} rowsPerPageOptions={[5, 10, 25, 50]} paginatorTemplate="PrevPageLink PageLinks NextPageLink" className='custpaginator custIcons custmBtnTable custTable' tableStyle={{ minWidth: '100%', maxWidth:'100%' }} >
                <Column field="product" headerClassName='header-filter' header="Brands" body={BuBodyTemplate} style={{ width: "15rem" }} />
                <Column field="lastYearProfit" sortable header="January" body={lastYearProfitBodyTemplate} style={{ width: "15rem" }}/>
                <Column field="lastYearProfit" sortable header="February" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }} />
                <Column field="lastYearProfit" sortable header="March" body={lastYearProfitBodyTemplate} style={{ width: "15rem" }}/>
                <Column field="thisYearProfit" sortable header="April" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }} />
                <Column field="thisYearProfit" sortable header="May" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }} />
                <Column field="thisYearProfit" sortable header="June" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }}/>
                <Column field="thisYearProfit" sortable header="July" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }}/>
                <Column field="thisYearProfit" sortable header="August" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }}/>
                <Column field="thisYearProfit" sortable header="September" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }}/>
                <Column field="thisYearProfit" sortable header="October" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }}/>
                <Column field="thisYearProfit" sortable header="November" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }}/>
                <Column field="thisYearProfit" sortable header="December" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }}/>
                <Column field="thisYearProfit" sortable header="FY 2022-23" body={thisYearProfitBodyTemplate} style={{ width: "15rem" }} />
              </DataTable>
            </div>
          </div>
