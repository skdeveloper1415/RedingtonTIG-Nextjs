...
export default function Index() {
  ...
  /*---Timeline Components--*/
  const events = [
    { status: "UAE", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "South Africa", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Saudi Arabia", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Rome", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Qatar", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Kuwait", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Kenya", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "FWN Africa", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Egypt", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "East Africa", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Bahrain", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Austria", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Mexico", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Canada", icon: "red-tsg-dot", color: "#98A2B3" },
    { status: "Denmark", icon: "red-tsg-dot", color: "#98A2B3" },
  ];
  ...
  const b2bStockQuarterlyTab = {
    ...
    xAxis: {
      type: "category",
      data: ["East Africa", "Egypt", "FWN Africa", "Kenya", "Kuwait","Qatar","Rome","Saudi","South Africa","U.A.E"],
      axisLabel: {
        fontSize: 12,
        color: currentTheme == 'dark' ? '#CACED1' : '#222222',
        width: 100,
    ...
    series: [
      {
        name: "B2B",
        stack: "vendor",
        data: [247, 206, 529, 279, 129, 214, 447, 406, 429, 418 ],
        type: "bar",
        color: "#029046",
        barGap: 0,
        barWidth: 50,
      ...
      },
      {
        name: "Stock",
        stack: "vendor",
        data: [147, 240, 270, 130, 410, 230, 240, 235, 200, 180],
        type: "bar",
        color: "#F5F073",
        barWidth: 50,
        label: {
    ...
    series: [
      {
        ...
        data: [1, 0.9, 1.2, 1.5, 1.6, 0.5, 0.7, 0.5],
        itemStyle: {
          color: "#029046",
        },
        lineStyle: {
        ...
        areaStyle: {
          color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
            {
              offset: 0,
              color: "rgba(225, 223, 169, 0.00)",
            },
            {
              offset: 1,

              color: "rgba(225, 223, 169, 0.20)",
            },
          ]),
        },
      },
      {
        ...
        data: [0.8, 0.9, 1, 0.5, 0.4, 0.8, 0.6, 0.5],
        itemStyle: {
          color: "#C5C050",
        },
        lineStyle: {
      ...
      },
      {
        ...
        data: [2, 2.1, 1.5, 1.8, 1, 1.2, 1.4, 2],
        itemStyle: {
          color: "#029046",
        },
        lineStyle: {
  ...
  return (
    <>
      <Layout pageTitle="Summary | Cluster">
          ...
          <div className="px-[40px] xl:px-[2.083vw] bg-white dark:bg-[#0F1013]">
            <div className="grid grid-cols-12 gap-[24px] xl:gap-[1.250vw]">
              ...
              <div className="col-span-12 lg:col-span-6 w-full">
                ...
                <div className="text-[#222222] dark:text-white text-[18px] xl:text-[0.938vw] font-medium mb-3">
                  Overall Scorecard
                </div>
                <div className="grid grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-x-[11px] xl:gap-x-[0.573vw] gap-y-[16px] xl:gap-y-[0.833vw]">
                  <div className="bg-[#EEF8F4] dark:bg-[rgba(255,255,255,0.05)] border border-[#CAE7CC] dark:border-[rgba(255,255,255,0.05)] rounded-[8px] xl:rounded-[0.417vw] p-[8px] xl:p-[0.417vw] space-y-[7px] overScor_hover">
                    <div className="text-[#344054] dark:text-[#CACED1] text-[12px] xl:text-[0.625vw]">
                      <p>Business Unit Wise</p>
                    </div>
                    <div className="text-[#667085] dark:text-[#777C81] text-[10px] xl:text-[0.521vw] font-light">
                     <p>Total Inventory Value (90 Days)</p>
                    </div>
                    <div className="flex space-x-[6px]">
                      <div className="text-[#222222] dark:text-white text-[10px] xl:text-[0.625vw] font-semibold">
                        $22,165,169.53
                      </div>
                ...
                <div className="bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded-[8px] xl:rounded-[0.417vw] mt-[40px] xl:mt-[2.083vw]">
                  <ChartWrapper
                    title={
                      activeIndex1 === 0
                        ? "Cluster Wise - Total Value"
                        : activeIndex1 === 1
                        ? "Cluster - Ageing Total Value - QnQ 2023"
                        : activeIndex1 === 2
                        ? "Cluster by Ageing"
                        : activeIndex1 === 3
                        ? "Cluster By Business Unit - Inventory Value and Provisional Value (91-120)"
                        : activeIndex1 === 4
                        ? "Cluster - B2B And Stock (91-120)"
                        : null
                    }
                    maximizeIcon={true}
                    ExportIcon={true}
                      ...
                      <>
                        <Tabs>
                          <div className="echartTabs">
                            ...
                            <TabPanel>
                            <div className="col relative -top-7 float-left">
                                <div className="flex space-x-1">
                                <div className="dark:bg-[#586C5D] bg-[#EEF8F4] border border-[#83C888] rounded-[6px] text-[11px] xl:text-[0.573vw] dark:text-[#C6CBD2] text-[#667085] py-[5px] px-[10px]">
                                <div cl>Provision Value</div>
                                  <div className="font-medium dark:text-[#F2F4F7] text-[#344054]">
                                  US$ 1,698K
                                  </div>
                                </div>
                                <div className="dark:bg-[#586C5D] bg-[#EEF8F4] border border-[#83C888] rounded-[6px] text-[11px] xl:text-[0.573vw] dark:text-[#C6CBD2] text-[#667085] py-[5px] px-[10px]">
                              ...
                              <div className="relative top-5" id="echartWrap">
                                <ReactEcharts
                                  option={b2bStockTab}
                                  style={{ width: "100%", height: "100%" }}
                                />
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 mt-[24px] xl:mt-[1.250vw] gap-[24px] xl:gap-[1.250vw]">
              <div className="bg-white dark:bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded-[8px] xl:rounded-[0.417vw] boxshadow2">
                <ChartWrapper
                  title={
                    activeIndex3 === 0
                      ? "Clusters - Inventory Values in US$"
                      : activeIndex3 === 1
                      ? "Clusters - Total Provisional Value 2023 in US$"
                      : null
                  }
                  maximizeIcon={true}
                  ExportIcon={true}
                      ...
                      <Tabs>
                          <div className="echartTabs">
                            <div className="flex items-center justify-between mb-5">
                              <div className="col">
                                <div className="font-medium text-[14px] xl:text-[0.729vw] text-white">Inventory Value</div>                                
                              </div>
                              <div className="col">
                                <TabList>
                                  <Tab onClick={() => setActiveIndex3(0)}>
                                  Inventory Value
                                  </Tab>
                                  <Tab onClick={() => setActiveIndex3(1)}>
                                  Provision Value
                                  </Tab>
                                </TabList>
                              </div>
              ...
              <div className="bg-white dark:bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded-[8px] xl:rounded-[0.417vw] boxshadow2">
                <ChartWrapper
                  title={"Top Brands By Business Group - Inventory - in US$"}
                  maximizeIcon={true}
                  ExportIcon={true}
                  data={
                    <>
            ...
            <div className="mt-[24px] xl:mt-[1.250vw] pb-[20px] custTabs">
              <Tabs>
                <div className="bg-white dark:bg-[rgba(255,255,255,0.02)] shadow-[0px_5px_5px_0px_rgba(0,0,0,0.08)] rounded-[8px] xl:rounded-[0.417vw] p-[10px] boxshadow2">
