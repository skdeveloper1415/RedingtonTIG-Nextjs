...
export default function Index() {
    ...
    /*--checkbox--*/
      ...
      const [sales] = useState([
        { product: 'CAABU', lastYearProfit: 423132, thisYearProfit: 312122 },
        { product: 'B2B', lastYearProfit: 423132, thisYearProfit: 312122,  className:'spacing' },
        { product: 'Stock', lastYearProfit: 423132, thisYearProfit: 312122 },
        { product: 'ESBU', lastYearProfit: 423132, thisYearProfit: 312122 },
        { product: 'B2B', lastYearProfit: 423132, thisYearProfit: 312122 },
        { product: 'IBU', lastYearProfit: 423132, thisYearProfit: 312122 },
        { product: 'B2B', lastYearProfit: 423132, thisYearProfit: 312122 },
        { product: 'Stock', lastYearProfit: 423132, thisYearProfit: 312122 },
        { product: 'NBU', lastYearProfit: 423132, thisYearProfit: 312122 },
        { product: 'B2B', lastYearProfit: 423132, thisYearProfit: 312122 },
    ]);
    ...
    const myCustomHeaderFilter = (columnName = '', isFilterApplicable = false) => {
      return <div className="flex justify-between flex-row-reverse gap-2">  
        ...
        {isFilterApplicable &&  
          <div>  
            <Link href={"/inventory/detailedview/nutanix"} className='dark:text-[#898A92] text-[#101828]'><i className="red-tsg-back-rounded text-base"></i></Link>  
          </div>
  ...
  return (
    ...
    <div className='bg-white dark:bg-[#14161A] border border-[#C6CBD2] dark:border-[#14161A] rounded-tl-lg rounded-tr-lg px-5 xl:px-[1.250vw] py-2 flex justify-between items-center'>
        <div className='flex gap-3 items-center'>
            ...
            <div className='text-[#888888] text-sm space-x-2 font-normal'>
                ...
                <span href={''} className='text-[#0056B8]'><i className='red-tsg-right-arrow text-[10px]'></i></span>
                <Link href={'/inventory/detailedview/nutanix'} className='text-[#0056B8] font-semibold'>NUTANIX</Link>
                <span href={''}><i className='red-tsg-right-arrow text-[10px]'></i></span>
                <span href={''}>Business Unit</span>
            </div>
        </div>
        <div className='flex items-center gap-2'>
            ...
            <div><Link href={'/inventory/detailedview/quarterly/businessunit'} className='text-[#344054] dark:text-[#CACED1] font-medium text-sm xl:text-[0.729vw] rounded-lg xl:px-4 px-[1.042vw] py-2 xl:py-[0.521vw] bg-white dark:bg-[#272F31] border border-[#C6CBD2] dark:border-[rgba(221,232,237,0.10)] inline-block'>Quarterly</Link></div>
    ...
    <DataTable value={sales} footerColumnGroup={footerGroup} scrollable paginator rows={8} rowsPerPageOptions={[5, 10, 25, 50]} paginatorTemplate="PrevPageLink PageLinks NextPageLink" className='custpaginator custIcons custmBtnTable custTable cust-spacing'  >
                <Column field="product" headerClassName='header-filter' header={myCustomHeaderFilter('Business Unit', true)} style={{minWidth:"8rem"}} />
                <Column field="lastYearProfit" sortable header="January" body={lastYearProfitBodyTemplate} style={{ minWidth: "6rem" }}/>
                <Column field="lastYearProfit" sortable header="February" body={thisYearProfitBodyTemplate} style={{ minWidth: "6rem" }} />
